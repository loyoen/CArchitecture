...
rem Copyright (c) Penrillian Ltd 2003-2006. All rights reserved.
rem Web: www.penrillian.com
cd ..\tests
perl -S ..\..\SymbianOSUnit\SymbianOSUnit\cxxtestgen.pl -o ..\generated\TestDriver.h Test_*.h
cd ..\group
@pause
